...
public static class Products
{
    ...
    static List<ProductInfoBase> CreateProducts() => new()
    {
        ...
        new GroupInfo("Application Services", "Application Services", () => new ApplicationServicesGroupViewModel(),
            () => "Dialogs, windows and file dialogs available to view models through services", ApplicationServicesGroupInfo.Create(), false),
