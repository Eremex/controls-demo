    ...
    public static class DataGridGroupInfo
    {
        internal static List<PageInfo> Create()
        {
            return new List<PageInfo>()
            {
                ...
                new PageInfo(name: "Large Data", title: "Large Data", description: "This example demonstrates the Data Grid control bound to a large data source.", viewModelGetter: () => new DataGridLargeDataViewModel(), badgeType: ProductBageType.New)
            };
        }
    }
}