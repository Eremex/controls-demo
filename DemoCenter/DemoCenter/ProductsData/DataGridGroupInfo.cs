    ...
    public static class DataGridGroupInfo
    {
        internal static List<PageInfo> Create()
        {
            return new List<PageInfo>()
            {
                ...
                new PageInfo(name: "Best Fit", title: "Best Fit", viewModelGetter: () => new DataGridBestFitViewModel(), descriptionGetter: () => Resources.DataGridBestFitDescription, introduced: new VersionInfo(1, 4), showInWeb: true),
