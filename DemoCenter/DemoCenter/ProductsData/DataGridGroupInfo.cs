    ...
    public static class DataGridGroupInfo
    {
        internal static List<PageInfo> Create()
        {
            return new List<PageInfo>()
            {
                ...
                new PageInfo(name: "Filter & Search", title: "Filter & Search", viewModelGetter: () => new DataGridFilteringViewModel(), descriptionGetter: () => Resources.DataGridSupportsBuiltInDataSearchAndFiltra, introduced: new VersionInfo(1, 0), updated: new VersionInfo(1, 2)),
                ...
                new PageInfo(name: "Export", title: "Export", viewModelGetter: () => new DataGridExportViewModel(), descriptionGetter: () => Resources.DataGridExportDescription, introduced: new VersionInfo(1, 2))
            };
        }
    }
}