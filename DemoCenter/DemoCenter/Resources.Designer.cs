...
namespace DemoCenter {
    ...
    public class Resources {
        ...
        ///• Swap Axes — With a single property, you can transpose the axes, so the Y axes are displayed hor [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// • Search Panel: Search for text across all columns. The Search Panel can be set to remain visible or activ [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        ///For instance, data can be aggregated to 1 second, 1 minute, 1 hour, 1 day, 1 week, etc. or to multiples of the selected time unit such as 5 seconds, 15 minutes, 2 [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to This demo showcases a 3D robotic arm loaded from an FBX file. Using the interactive panel on the right, you can manipulate each joint (from the base to the claw) by applying transformations to nested 3D models..
        /// </summary>
        ...
        /// • Search Panel: Search for text across all columns. The Search Panel can be set to remain visibl [rest of string was truncated]&quot;;.
        /// </summary>
