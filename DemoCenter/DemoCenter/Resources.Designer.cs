...
namespace DemoCenter {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to IChoiceDialogService fills the gap IMessageBoxService leaves: where message boxes only offer fixed button sets and always return DialogResult, this service accepts arbitrary captions and returns whatever result type the caller chooses.
        /// • Custom captions — buttons such as &quot;Show log&quot; or &quot;Retry&quot; that no standard set provides.
        /// • Arbitrary result type — a plain bool, a custom enum, or any other struct.
        /// • Docked choices — secondary actions, like Help, can be placed apart from the main buttons..
        /// </summary>
        public static string ApplicationServicesChoiceDialogsDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesChoiceDialogsDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Modal dialogs whose title, content and buttons are supplied by a view model through IDialogService, rather than assembled in markup. This demo showcases the following scenarios:
        /// • Ok / Cancel — the base class creates the standard button pair with no extra code.
        /// • Apply / Cancel — overriding CreateButtons replaces the standard set with a custom one.
        /// • Yes / No with Dock — buttons carry custom captions and can be docked to either side.
        /// • Validation — CanOk keeps the default button disabled until the i [rest of string was truncated]&quot;;.
        /// </summary>
        public static string ApplicationServicesDialogsDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesDialogsDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Open and save dialogs through IOpenFileDialogService and ISaveFileDialogService, each with a synchronous and an asynchronous variant — the synchronous one holds the calling thread on a nested message loop and exists for legacy code, new code should prefer ShowAsync. This demo covers picking a single file, picking multiple files with AllowMultiple, and saving with a suggested name, a default extension, an overwrite prompt, and a well-known starting folder..
        /// </summary>
        public static string ApplicationServicesFileDialogsDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesFileDialogsDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Standard message boxes shown through IMessageBoxService, with a fixed set of buttons and icons: Ok/Information, Yes/No/Question, Yes/No/Cancel/Warning, Retry/Cancel/Error. The owner window can be passed explicitly; when it is omitted, the service asks IWindowsManager for the currently active window..
        /// </summary>
        public static string ApplicationServicesMessageBoxesDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesMessageBoxesDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Application Services describe what to register, not how: the host decides which container and which lifetime to use. This demo lists every service RegisterApplicationServices hands over, then resolves each one to confirm the wiring is complete.
        /// • Microsoft.Extensions.DependencyInjection and Autofac — both integrate through the same callback, registering each service as a singleton.
        /// • No container at all — the built-in SimpleServiceProvider, which is what this demo itself uses.
        /// • Constructor injection  [rest of string was truncated]&quot;;.
        /// </summary>
        public static string ApplicationServicesRegistrationDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesRegistrationDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Non-modal windows opened through IWindowService, and IWindowsManager, which tracks the currently active window so that every other service can fall back to it when no owner is given explicitly. The caption passed to the service overrides the one set on the view model, and a modal dialog opened from one of several open windows blocks only that window..
        /// </summary>
        public static string ApplicationServicesWindowsDescription {
            get {
                return ResourceManager.GetString("ApplicationServicesWindowsDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Two cars side by side, with the better figure in each row picked out in green and the weaker one in red. Which way is better depends on the row: more power, more gears and more miles per gallon win, a lower price wins, and rows such as displacement or transmission type are left uncoloured because neither value is an advantage. Change either car in the drop-down above its picture and the comparison is rebuilt..
        /// </summary>
        public static string CarComparison_Desc {
            get {
                return ResourceManager.GetString("CarComparison_Desc", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The AllowDragDropSortedRows option must be enabled to allow drag-and-drop operations for sorted/grouped Data Grids. When data is sorted or grouped, a drag-and-drop operation modifies values of a dragged row in sort columns..
        /// </summary>
        public static string DataGridAllowDragDropSortedRowsTooltip {
            get {
                return ResourceManager.GetString("DataGridAllowDragDropSortedRowsTooltip", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The Best-Fit feature resizes columns to ensure their contents are fully visible. It calculates and applies the ideal minimum width required for each column to display its values without truncation. Users can invoke Best-Fit in two ways:
        ///• Double-click a column header&apos;s right edge
        ///• Select &quot;Best Fit&quot; or &quot;Best Fit All Columns&quot; from a column&apos;s context menu
        ///The &quot;Reset Column Width&quot; command (available in column context menus) restores columns to their original widths. This command reverts any manual resizing  [rest of string was truncated]&quot;;.
        /// </summary>
        public static string DataGridBestFitDescription {
            get {
                return ResourceManager.GetString("DataGridBestFitDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Two Best-Fit calculation modes are available:
        ///• Fast mode — Calculates optimal column widths against unique row values, ensuring better performance. This mode may be less accurate in certain scenarios, such as when the grid uses cell templates.
        ///• Full mode — Calculates optimal column widths against all row values. Although slower than Fast, this mode delivers the most accurate results when the grid uses cell templates or displays data source validation errors in cells..
        /// </summary>
        public static string DataGridBestFitModeTooltip {
            get {
                return ResourceManager.GetString("DataGridBestFitModeTooltip", resourceCulture);
            }
        }
        ...
        ///In this example, the controls are bound to collections that contain the same business objects. This ensures automatic row movement during drag-and-drop operations from the source to the target grid. When you move a row from one g [rest of string was truncated]&quot;;.
        /// </summary>
        public static string DataGridDragAndDropDescription {
            get {
                return ResourceManager.GetString("DataGridDragAndDropDescription", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to DataGrid can calculate summaries against rows and display them in the summary footer at the bottom.
        ///• Supported summary types: Sum, Min, Max, Count, and Average.
        ///• End users can manage summaries at runtime: click the Σ button in the footer cell to add summaries, or select &quot;Σ → Customize&quot; to invoke the Summary Editor dialog.
        ///• Each column can display multiple summaries calculated against that column&apos;s values.
        ///• You can calculate a summary against one column and display it in another.
        ///• Handle the Custom [rest of string was truncated]&quot;;.
        /// </summary>
        public static string DataGridTotalSummariesDescription {
            get {
                return ResourceManager.GetString("DataGridTotalSummariesDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to To allow rows to be dragged to other applications, enable the UsePlatformRowDragDrop property. This property activates a drag-and-drop mode in which operations are handled by the Avalonia platform. No row previews are shown during platform-based row drag operations..
        /// </summary>
        public static string DataGridUsePlatformDragDropTooltip {
            get {
                return ResourceManager.GetString("DataGridUsePlatformDragDropTooltip", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to This example demonstrates the Property Grid&apos;s layout settings.
        ///• Widths of the caption and editor columns — Each column&apos;s width can be a fixed number of pixels or a proportion of the available space (star sizing).
        ///• Caption alignment — Captions can be aligned within the caption column to the left or right edge, centered, or stretched.
        ///• Built-in resizer — The resizer allows a user to redistribute space between the caption and editor columns at runtime..
        /// </summary>
        public static string PropertyGridLayoutDescription {
            get {
                return ResourceManager.GetString("PropertyGridLayoutDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Property Grid allows you to show and edit the properties of multiple objects simultaneously. If the objects are of different types, the control shows only the properties they have in common.
        ///In this demo, Ctrl-click to select several employees in the table on the left and show their properties in the Property Grid. The Property Grid displays the property values in common and blanks the differing values. Editing any property writes the change back to all selected employees..
        /// </summary>
        public static string PropertyGridMultipleObjectsDescription {
            get {
                return ResourceManager.GetString("PropertyGridMultipleObjectsDescription", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The data validation mechanism allows you to check cell values and show errors in cells that contain invalid data. You can use DataAnnotation attributes and the IDataErrorInfo/INotifyDataErrorInfo interface to validate data at the bound object level. 
        ///PropertyGrid also allows you to handle the ValidateRowValue event to perform custom validation. Toggle the checkboxes under the Rules section to see individual validation rules in action..
        /// </summary>
        public static string PropertyGridValidationDescription {
            get {
                return ResourceManager.GetString("PropertyGridValidationDescription", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Everything about the ribbon that is decided by the application rather than by its commands: the classic and the simplified command layouts and the button that lets the user switch between them, the application button, and the quick access toolbar - shown above or below the ribbon, with or without its customization menu. Drag the width slider to watch the groups collapse into drop-down buttons as the room runs out. The status bar under the page is a Bars toolbar in status bar mode, sharing the toolbar manage [rest of string was truncated]&quot;;.
        /// </summary>
        public static string RibbonLayoutDescription {
            get {
                return ResourceManager.GetString("RibbonLayoutDescription", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to TreeList can calculate summaries against rows and display them in the summary footer at the bottom.
        ///• Supported summary types: Sum, Min, Max, Count, and Average.
        ///• End users can manage summaries at runtime: click the Σ button in the footer cell to add summaries, or select &quot;Σ → Customize&quot; to invoke the Summary Editor dialog.
        ///• Each column can display multiple summaries calculated against that column&apos;s values.
        ///• You can calculate a summary against one column and display it in another.
        ///• Summaries are cal [rest of string was truncated]&quot;;.
        /// </summary>
        public static string TreeListTotalSummariesDescription {
            get {
                return ResourceManager.GetString("TreeListTotalSummariesDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to This demo emulates a dynamic mortgage calculator, built with the Data Grid and Cartesian Chart controls. Data Grid presents a detailed payment schedule as a table. The synchronized chart plots this data to show the relationship between principal and interest over the life of the loan..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to A parts catalogue for a fleet of yachts, shown as a master detail pair of Data Grids. The upper grid lists the vessels; the lower one shows the parts that fit the selected vessel, grouped by system, with the selected part previewed beside it. The same parts catalogue is shared with the vehicles, so a part reached from a yacht is the same record a car would reach..
        /// </summary>
        public static string YachtParts_Desc {
            get {
                return ResourceManager.GetString("YachtParts_Desc", resourceCulture);
            }
        }
