...
namespace DemoCenter {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Column bands allow you to visually group columns together. The DataGrid control displays bands as additional headers above column headers. Both band and column headers can include text, images, or custom content. You can create hierarchical bands with an unlimited number of nesting levels..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Column bands allow you to visually group columns together. The TreeList control displays bands as additional headers above column headers. Both band and column headers can include text, images, or custom content. You can create hierarchical bands with an unlimited number of nesting levels..
        /// </summary>
